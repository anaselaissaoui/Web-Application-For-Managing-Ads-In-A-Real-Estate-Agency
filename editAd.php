                    ...
                    <ul class="list-unstyled ">
                        ...
                        <li>
                            ...
                            if (isset($_SESSION['nom']) && isset($_SESSION['prenom'])) {
                                ...
                                echo "<h6 class='text-white'>" . $_SESSION['nom'] . " " . $_SESSION['prenom'] . "</h6>";
                            } else {
                ...
                <div class="login-wrap p-0">
                    <form method="POST" class="signin-form" enctype="multipart/form-data">
                        <div class="col-md-6 text-center mb-5">
                            <h2 class="heading-section">Edit annonce</h2>
                        </div>
                        <!-- title -->
                        ...
                        <!-- surface -->
                        <div class="form-group">
                            <input type="number" name="surface" class="form-control" placeholder="Surface" value="<?php echo $Surface; ?>">
                        ...
                        <!-- off date -->
                        <div class="form-group">
                            <input type="date" name="offDate" class="form-control" placeholder="Offer date" value="<?php echo $OfferDate; ?>">
                        ...
                        <div class="form-group">
                            <select name="category" class="form-control form-select border-0 py-3">
                                <option value="<?php echo $Category; ?>">Current Category : <?php echo $Category; ?> </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="dropzone">
                                ...
                                <input type="file" value="" class="upload-input" name="image4" onchange="previewImage(event, 'preview4')" />
                            </div>
                        </div>
                        ...
                        ?>
                        <div class="form-group">
                            <button name="submit" class="form-control btn btn-success submit px-3">Edit Annonce</button>
                        </div>
                    </form>
                </div>
            </div>
...
if (isset($_POST['submit'])) {
    ...
    $offDate = mysqli_real_escape_string($conn, $_POST['offDate']);
    ...
    if (!isset($title) || !isset($city) || !isset($address) || !isset($price) || !isset($surface) || !isset($offDate) || !isset($category) || !isset($type) || $_FILES['image1']['error'] === UPLOAD_ERR_NO_FILE) {
        echo '**please enter all the values ....';
    } else {
        $imagesAfterEdit = array();
        # IMAGES
        #image1
        ...
        if (isset($_POST["image4"])) {
            ...
            $fileExtension4 = explode('.', $filename1);
        ...
        $sql2 = "UPDATE  images WHERE id_annonce=$id_annonce (image, is_Principale, id_annonce) VALUES";

        $hasImage = false;

        if ($FILES['image1']['name']){
            move_uploaded_file($imagename1, $folder1);
            $sql2 .= "('" . $folder1 . "', TRUE, $id_annonce)";
            $hasImage = true;
        }
    ...
    header('location: myAds.php');  # return page addAnn.php
